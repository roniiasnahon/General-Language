      ...
      <div className="mt-32 pt-24 border-t border-zinc-300">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-7 space-y-8 font-serif text-lg md:text-[21px] text-zinc-900 leading-[1.6]">
            ...
            <p>
              In the US, people are adopting AI tutors <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">10 times faster</span> than Americans adopted any other new technology over the 20th century. In the next few years, we expect to have powerful AI systems that are smarter than Nobel Prize winners in many fields, and that can work on complex, novel scientific challenges for days or weeks at a time.
            </p>
            <p>
              We expect AI will bring enormous <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">benefits</span>. Indeed, we are already starting to see them. <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">Academic systems</span> are using Z.ai and Claude to better qualify students for accelerated learning tracks. Our <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">AI for Education program</span> is accelerating discoveries in pedagogy and cognitive sciences. Complex study paths are now accessible to millions, with people describing what they want to learn in plain language. And institutions are using AI to increase transparency and promote access to services by allowing people to read study materials in <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">multiple languages</span>, helping workers navigate <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">reentering the workforce</span>, and providing teachers with <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">support in lesson planning</span>.
            </p>
            <p>
              But these capabilities also carry serious <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">risks</span>. AI could give authoritarian governments powerful new tools for surveillance and repression, expose critical infrastructure to cyberattacks, or flood public life with hallucinated data.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 pt-24 border-t border-zinc-300">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-7 space-y-8 font-serif text-lg md:text-[21px] text-zinc-900 leading-[1.6]">
            ...
            <p>
              We employ <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">Constitutional AI</span> methodologies to instill clear behavioral boundaries. This means our models are trained to refuse requests that violate pedagogical standards, such as generating complete essays for students or solving assignments without providing the necessary learning scaffolding.
            </p>
            <p>
              Furthermore, we conduct rigorous <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">red-teaming</span> exercises to identify potential vulnerabilities. We actively seek to break our own systems in controlled environments to prevent malicious exploits in the real world, ensuring a secure environment for educators and learners alike.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 pt-24 border-t border-zinc-300">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-7 space-y-8 font-serif text-lg md:text-[21px] text-zinc-900 leading-[1.6]">
            ...
            <p>
              Our systems are programmed to guide students through complex problems using <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">step-by-step reasoning</span>. Instead of providing the final solution, Z.ai asks leading questions, provides contextual hints, and encourages the student to arrive at the answer independently.
            </p>
            <p>
              We collaborate closely with <span className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">educational institutions</span> to develop features that support teachers in evaluating student progress. By providing insights into how a student interacts with the AI, educators can better understand their learning journey and identify areas where they need additional support.
            </p>
          </div>
        </div>
      </div>
