      ...
      <div className="mt-32 pt-24 border-t border-zinc-300">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-7 space-y-8 font-serif text-lg md:text-[21px] text-zinc-900 leading-[1.6]">
            ...
            <p>
              In the US, people are adopting AI tutors <a href="#policy/10-times-faster" className="underline decoration-1 underline-offset-4 cursor-pointer hover:text-zinc-600 transition-colors">10 times faster</a> than Americans adopted any other new technology over the 20th century. In the next few years, we expect to have powerful AI systems that are smarter than Nobel Prize winners in many fields, and that can work on complex, novel scientific challenges for days or weeks at a time.
            </p>
            <p>
