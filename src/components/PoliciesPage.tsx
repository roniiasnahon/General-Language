  ...
  'academic-systems': {
    ...
    content: (
      <>
        ...
        <p>
          Furthermore, native integration ensures that all AI-assisted work remains strictly within the institution's verifiable, auditable boundary. This is paramount for adhering to stringent local privacy regulations (such as FERPA in the United States or GDPR in Europe).
        </p>
        <p>
